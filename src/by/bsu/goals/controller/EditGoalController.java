        ...
        OnTimeSetListener
{
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute)
    {
        ...
        {
            case FINISHED_AT:
                date = DateUtil.parseStringToDate(DateUtil.DATE_TEMPLATE_dd_MMM_yyyy,
        ...
        if (!DateUtil.isValidDates(activity.changeStartDate.getText().toString(),
                activity.changeFinishDate.getText().toString()))
        {
            revertDateChanges();
        }
    ...
    public void fillUIInfo()
    {
        ...
        activity.changeStartDate
                .setText(DateUtil.formatDateToString(
